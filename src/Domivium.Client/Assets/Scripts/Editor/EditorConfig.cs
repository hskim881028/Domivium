...
namespace Domivium.Client.Editor
{
    public static class EditorConfig
    {
        ...
        //Keys
        public const string SelectedTypeKey = "UI_EDITOR_SELECTED_UI_TYPE";
        public const string SelectedNameKey = "UI_EDITOR_SELECTED_UI_NAME";
        ...
        private static string RootPath => Application.dataPath; // Absolute path to Assets
