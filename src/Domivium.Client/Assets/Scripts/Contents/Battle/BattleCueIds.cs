...
namespace Domivium.Client.Contents.Battle
{
    public static class BattleCueIds
    {
        ...
        public static BattleCueId Avoid = new(2);
        public static BattleCueId Attack = new(4);

        public static BattleCueId Die = new(100);
        public static BattleCueId Heal = new(101);
        public static BattleCueId Healed = new(102);
        public static BattleCueId Damaged = new(103);
    }
}